...
const navigation = [
  ...
  { to: '/transactions/income', label: 'Kas Masuk', icon: ArrowDownToLine, roles: ['ADMIN', 'TREASURER'] },
  { to: '/transactions/expense', label: 'Kas Keluar', icon: ArrowUpFromLine, roles: ['ADMIN', 'TREASURER'] },
